---
id: breweries/hammer-spring-distillers
title: "Hammer Spring Distillers"
status: published
tags: [brewery, "US"]
---
...
post_id: 202
post_type: page
guid: https://www.drawmeanelephant.com/?page_id=202
post_name: hammer-spring-distillers
author: Timothy
post_date: 2019-07-20 20:05:26
link: https://www.drawmeanelephant.com/hammer-spring-distillers/
conversion: human_review
-->

So I get notifications in my email form [Informed Delivery](https://informeddelivery.usps.com/) telling me when I'm getting mail or packages so I knew today was going to be a day I get to see an elephant from [Whiskey Del Bac](https://www.whiskeydelbac.com/) and was surprised to see the mailman today carrying an oversized envelope that was too big for Informed Delivery to scan and send. It was a letter from [Hammer Spring](http://hammerspring.com/) that contained a letter and an elephant while the other was just stickers, so that went on the Whiskey Del Bac burner (probably the best dad joke you'll read today).
...
*   📁 [Hammer Spring Distillers Correspondence Part 2](hammer-spring-distillers/instagram-2.html)
*   📁 [Hammer Spring Distillers Correspondence Part 3](hammer-spring-distillers/instagram-3.html)
